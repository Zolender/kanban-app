            ...
            <nav className="sticky top-0 z-50 w-full px-6 py-4">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    ...
                    <div className="flex justify-center items-center gap-5">
                        <p className="font-semibold text-sm text-slate-400">Features</p>
                        <p className="font-semibold text-sm text-slate-400">Methodology</p>
                        <p className="font-semibold text-sm text-slate-400">Pricing</p>
                    </div>
